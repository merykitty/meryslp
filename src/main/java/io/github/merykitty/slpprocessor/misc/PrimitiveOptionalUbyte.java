...
@__primitive__
public class PrimitiveOptionalUbyte {
     ...
     */
    public static PrimitiveOptionalUbyte empty() {
        return PrimitiveOptionalUbyte.default;
    }
     ...
     */
    private PrimitiveOptionalUbyte(ubyte value) {
        this.present = true;
        this.value = value;
    }
     ...
     */
    public static PrimitiveOptionalUbyte of(ubyte value) {
        return new PrimitiveOptionalUbyte(value);
    }
     ...
     */
    public ubyte orElse(ubyte other) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof PrimitiveOptionalUbyte other) {
