 ...
 */
@__primitive__
public class PrimitiveOptional<T> {
    /**
     ...
     */
    public static<T> PrimitiveOptional<T> empty() {
        @SuppressWarnings("unchecked")
        var result = (PrimitiveOptional<T>) PrimitiveOptional.default;
        return result;
    }
     ...
     */
    private PrimitiveOptional(T value) {
        this.value = value;
    }
     ...
     */
    public static <T> PrimitiveOptional<T> of(T value) {
        return new PrimitiveOptional<>(Objects.requireNonNull(value));
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> PrimitiveOptional<T> ofNullable(T value) {
        return new PrimitiveOptional<>(value);
    }
     ...
     */
    public PrimitiveOptional<T> filter(Predicate<? super T> predicate) {
     ...
     */
    public <U> PrimitiveOptional<U> map(Function<? super T, ? extends U> mapper) {
        Objects.requireNonNull(mapper);
        if (!isPresent()) {
            return empty();
        } else {
            return PrimitiveOptional.ofNullable(mapper.apply(value));
        }
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof PrimitiveOptional other) {
